...
const Logo = ({colour, maxSize}) => {
    ...
    return (
        <svg version="1.1"
             ...
             style={svgStyle}
             alt='Orogen Tech'>
            <path className={'logo-colour '.concat(colour)}
                  d="M50,1C22.9,1,1,22.9,1,50s21.9,49,49,49s49-21.9,49-49S77.1,1,50,1z M59.2,15.8c0,18.3-14.9,33.1-33.1,33.1
